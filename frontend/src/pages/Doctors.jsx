...
const Doctors = () => {
  ...
  return (
    <div>
      ...
      <button
  className={`py-1 px-3 border rounded text-sm transition-all duration-300 sm:hidden ${showFilter ? 'bg-primary text-white' : 'bg-white text-black'}`}
...
>
  Filters
    ...
    <div className='flex items-center gap-2 text-sm'>
        ...
        <p className={`font-medium ${item.available ? 'text-green-500' : 'text-red-500'}`}>
